public class ISBN implements Comparable{
  ...
  public int compareTo(Object other){
    ISBN otherISBN = (other instanceof ISBN) ? (ISBN) other : new ISBN();
    if((this.isbn).compareTo(otherISBN.getISBN()) == 0){
      return 0;
    }else if((this.isbn).compareTo(otherISBN.getISBN()) < 0){
      return -1;
    }else{
      return 1;
    }
